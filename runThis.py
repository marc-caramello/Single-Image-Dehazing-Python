...
def CreateOutputLogFile(runtime_faster, runtime_old):
    ...
    divisionDiff = str(round(runtime_old / runtime_faster, 5))
    ...
    f.write(runtime_old + " / " + runtime_faster + " = " + divisionDiff + ", img_dehazeFaster is " + divisionDiff + "× faster than img_dehazeOld")
    f.close()
